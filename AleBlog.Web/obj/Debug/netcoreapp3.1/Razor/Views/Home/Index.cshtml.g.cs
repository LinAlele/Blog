#pragma checksum "D:\代码库\AleBlog\AleBlog.Web\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "efc29957e660a86f7aa441010cc016977ed70632"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"efc29957e660a86f7aa441010cc016977ed70632", @"/Views/Home/Index.cshtml")]
...
");
            DefineSection("Scripts", async() => {
                WriteLiteral("\r\n        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "efc29957e660a86f7aa441010cc016977ed706325020", async() => {
                }
                );
                ...
                WriteLiteral("\r\n        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "efc29957e660a86f7aa441010cc016977ed706326123", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
        ...
        <script>
            ...
            //pi
             //var api_domain = ""http://192.168.1.17:7002"";
            ...
            function queryPage() {
                ...
                axios.get(`${api_domain}/blog/page/querypage?Page=${page == false ? '1' : page}&Limit=${limit == false ? '4' : limit} `, { withCredentials: true }).then(function (response) {
                    ...
                    if (response.status == '200') {
                        ...
                        var InitP");
                WriteLiteral(@"ageNum = 5;//分页一行显示5页
...
");
                WriteLiteral(@"                                    pagingHtml += page == pageIndex ? `<span class=""pagnum curr"">${pageIndex}</span>` : `<a class=""pagnum"" href=""?page=${pageIndex}&limit=${limit}"">${pageIndex}</a>`;
                                }
                            ...
                            if (page >= InitPageNum && page <= totalPaging - InitPageNum) {
                                ...
                                for (pageIndex = (page - mp); pageIndex <= (page + mp); pageIndex++) {
                                    pagingHtml += page == pageIndex ? `<span class=""pagnum curr"">${pageIndex}</span>` : `<a class=""pagnum"" href=""?page=${pageI");
                WriteLiteral(@"ndex}&limit=${limit}"">${pageIndex}</a>`;
                                }
                                pagingHtml += '<span class=""pagnum"">...</span>';
                                pagingHtml += `<a class=""pagnum"" href=""?page=${totalPaging}&limit=${limit}"">${totalPaging}</a>`;
                            }
                            ...
                            pagingH");
                WriteLiteral(@"tml += page == totalPaging ? `<span class=""pagnum curr"">▼</span>` : `<a class=""pagnum"" href=""?page=${page - 1}&limit=${limit}"">▼</a>`;
                        }
